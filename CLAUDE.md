# PlutoResource - Claude Code Guide

## Site
- URL: https://plutoresource.net
- Repo: https://github.com/corganb/plutoresource
...
- Cloudflare Pages project name: `plutoresource-site`
...
## Pluto quirks
- Spacecraft present in scene: New Horizons
...
```
wrangler pages deploy public --project-name=plutoresource-site --branch=main
```
